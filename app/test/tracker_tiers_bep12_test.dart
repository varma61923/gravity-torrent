...
''';
    ...
    test(
        'TorrentCreatorService.create generates BEP 12 announce and announce-list metainfo',
        () async {
      final tempDir =
          Directory.systemTemp.createTempSync('bep12_torrent_test_');
      try {
...
''';
        final parsedTiers =
            TorrentCreatorService.parseTrackerTiers(trackerText);
        ...
        expect(
          metadata.announce,
          equals('http://primary1.tracker.org/announce'),
        );
